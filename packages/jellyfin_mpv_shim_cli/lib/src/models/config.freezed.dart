...
class _Config implements Config {
  const _Config({this.clientName = 'Jellyfin MPV Shim', this.mpvExecutable = 'mpv', final  List<String> mpvArgs = const [], this.progressReportInterval = 5, this.verbose = false, this.autoReconnect = true, this.maxReconnectAttempts = 5, this.reconnectDelay = 5}): _mpvArgs = mpvArgs;
