...
class _ChannelsClient implements ChannelsClient {
  ...
  Future<ChannelFeatures> getChannelFeatures({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ChannelFeatures _value;
    try {
      _value = ChannelFeatures.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<ChannelFeatures>> getAllChannelFeatures({
    ...
    late List<ChannelFeatures> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ChannelFeatures.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
