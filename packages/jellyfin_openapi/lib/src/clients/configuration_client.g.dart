...
class _ConfigurationClient implements ConfigurationClient {
  ...
  Future<ServerConfiguration> getConfiguration({
    ...
    late ServerConfiguration _value;
    try {
      _value = ServerConfiguration.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MetadataOptions> getDefaultMetadataOptions({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late MetadataOptions _value;
    try {
      _value = MetadataOptions.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
