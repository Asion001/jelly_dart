...
part of 'environment_client.dart';
...
class _EnvironmentClient implements EnvironmentClient {
  _EnvironmentClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<DefaultDirectoryBrowserInfoDto> getDefaultDirectoryBrowser({
    ...
    late DefaultDirectoryBrowserInfoDto _value;
    try {
      _value = DefaultDirectoryBrowserInfoDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<FileSystemEntryInfo>> getDirectoryContents({
    ...
    late List<FileSystemEntryInfo> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                FileSystemEntryInfo.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  @override
  Future<List<FileSystemEntryInfo>> getDrives({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
