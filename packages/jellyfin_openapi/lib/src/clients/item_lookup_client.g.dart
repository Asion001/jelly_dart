...
part of 'item_lookup_client.dart';
...
class _ItemLookupClient implements ItemLookupClient {
  _ItemLookupClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<ExternalIdInfo>> getExternalIdInfos({
    ...
    late List<ExternalIdInfo> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ExternalIdInfo.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<RemoteSearchResult>> getBookRemoteSearchResults({
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<RemoteSearchResult> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                RemoteSearchResult.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
