...
part of 'item_update_client.dart';
...
class _ItemUpdateClient implements ItemUpdateClient {
  _ItemUpdateClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<MetadataEditorInfo> getMetadataEditorInfo({
    ...
    late MetadataEditorInfo _value;
    try {
      _value = MetadataEditorInfo.fromJson(_result.data!);
    } on Object catch (e, s) {
