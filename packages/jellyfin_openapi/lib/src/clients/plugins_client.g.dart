...
class _PluginsClient implements PluginsClient {
  _PluginsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<PluginInfo>> getPlugins({RequestOptions? options}) async {
    ...
    late List<PluginInfo> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => PluginInfo.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  @override
  Future<dynamic> getPluginConfiguration({
    required String pluginId,
    RequestOptions? options,
  }) async {
    final _extra = <String, dynamic>{};
