...
part of 'remote_image_client.dart';
...
class _RemoteImageClient implements RemoteImageClient {
  _RemoteImageClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<RemoteImageResult> getRemoteImages({
    ...
    late RemoteImageResult _value;
    try {
      _value = RemoteImageResult.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<ImageProviderInfo>> getRemoteImageProviders({
    ...
    late List<ImageProviderInfo> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ImageProviderInfo.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
