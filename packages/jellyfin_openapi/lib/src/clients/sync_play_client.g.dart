...
class _SyncPlayClient implements SyncPlayClient {
  _SyncPlayClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GroupInfoDto> syncPlayGetGroup({
    ...
    late GroupInfoDto _value;
    try {
      _value = GroupInfoDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<void> syncPlayLeaveGroup({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<List<GroupInfoDto>> syncPlayGetGroups({
    ...
    late List<GroupInfoDto> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => GroupInfoDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  @override
  Future<void> syncPlayPause({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<void> syncPlayStop({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<void> syncPlayUnpause({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
