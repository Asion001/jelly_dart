...
class _TrickplayClient implements TrickplayClient {
  _TrickplayClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Stream<String> getTrickplayTileImage({
    ...
    final queryParameters = <String, dynamic>{r'mediaSourceId': mediaSourceId};
