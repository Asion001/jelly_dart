...
class _UserClient implements UserClient {
  ...
  Future<AuthenticationResult> authenticateUserByName({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AuthenticationResult _value;
    try {
      _value = AuthenticationResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<ForgotPasswordResult> forgotPassword({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ForgotPasswordResult _value;
    try {
      _value = ForgotPasswordResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PinRedeemResult> forgotPasswordPin({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PinRedeemResult _value;
    try {
      _value = PinRedeemResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<UserDto> getCurrentUser({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<List<UserDto>> getPublicUsers({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
