...
part of 'user_views_client.dart';
...
class _UserViewsClient implements UserViewsClient {
  _UserViewsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<SpecialViewOptionDto>> getGroupingOptions({
    ...
    late List<SpecialViewOptionDto> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                SpecialViewOptionDto.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
