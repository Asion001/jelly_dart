...
part of 'video_attachments_client.dart';
...
class _VideoAttachmentsClient implements VideoAttachmentsClient {
  _VideoAttachmentsClient(this._dio, {this.baseUrl, this.errorLogger});
