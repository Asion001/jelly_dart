...
abstract class BaseItemDto with _$BaseItemDto {
  const factory BaseItemDto({
    ...
    required BaseItemDtoMediaType mediaType,
    ...
    BaseItemDtoExtraType? extraType,
    ...
    BaseItemDtoVideo3DFormat? video3DFormat,
    ...
    BaseItemDtoPlayAccess? playAccess,
    ...
    BaseItemDtoVideoType? videoType,
    ...
    BaseItemDtoLocationType? locationType,

    /// Gets or sets the type of the iso.
    @JsonKey(name: 'IsoType')
    BaseItemDtoIsoType? isoType,
    ...
    BaseItemDtoChannelType? channelType,

    /// Gets or sets the audio.
    @JsonKey(name: 'Audio')
    BaseItemDtoAudio? audio,
