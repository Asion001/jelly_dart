...
part 'box_set_info.freezed.dart';
part 'box_set_info.g.dart';

@Freezed()
abstract class BoxSetInfo with _$BoxSetInfo {
  const factory BoxSetInfo({
  ...
  factory BoxSetInfo.fromJson(Map<String, Object?> json) => _$BoxSetInfoFromJson(json);
}
