...
mixin _$BoxSetInfo {
  ...
  /// Create a copy of BoxSetInfo
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BoxSetInfoCopyWith<BoxSetInfo> get copyWith =>
      _$BoxSetInfoCopyWithImpl<BoxSetInfo>(this as BoxSetInfo, _$identity);

  /// Serializes this BoxSetInfo to a JSON map.
  ...
  @override
  String toString() {
    return 'BoxSetInfo(name: $name, originalTitle: $originalTitle, path: $path, metadataLanguage: $metadataLanguage, metadataCountryCode: $metadataCountryCode, providerIds: $providerIds, year: $year, indexNumber: $indexNumber, parentIndexNumber: $parentIndexNumber, premiereDate: $premiereDate, isAutomated: $isAutomated)';
  }
}

/// @nodoc
abstract mixin class $BoxSetInfoCopyWith<$Res> {
  factory $BoxSetInfoCopyWith(
    BoxSetInfo value,
    $Res Function(BoxSetInfo) _then,
  ) = _$BoxSetInfoCopyWithImpl;
  @useResult
  $Res call({
...
/// @nodoc
class _$BoxSetInfoCopyWithImpl<$Res> implements $BoxSetInfoCopyWith<$Res> {
  _$BoxSetInfoCopyWithImpl(this._self, this._then);

  final BoxSetInfo _self;
  final $Res Function(BoxSetInfo) _then;
...
/// Adds pattern-matching-related methods to [BoxSetInfo].
extension BoxSetInfoPatterns on BoxSetInfo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BoxSetInfo value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _BoxSetInfo() when $default != null:
...
/// @nodoc
@JsonSerializable()
class _BoxSetInfo implements BoxSetInfo {
  const _BoxSetInfo({
  ...
  factory _BoxSetInfo.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BoxSetInfoCopyWith<_BoxSetInfo> get copyWith =>
      __$BoxSetInfoCopyWithImpl<_BoxSetInfo>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BoxSetInfoToJson(this);
  }
...
/// @nodoc
abstract mixin class _$BoxSetInfoCopyWith<$Res>
    implements $BoxSetInfoCopyWith<$Res> {
  factory _$BoxSetInfoCopyWith(
    _BoxSetInfo value,
    $Res Function(_BoxSetInfo) _then,
  ) = __$BoxSetInfoCopyWithImpl;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'Name') String? name,
...
/// @nodoc
class __$BoxSetInfoCopyWithImpl<$Res> implements _$BoxSetInfoCopyWith<$Res> {
  __$BoxSetInfoCopyWithImpl(this._self, this._then);

  final _BoxSetInfo _self;
  final $Res Function(_BoxSetInfo) _then;
