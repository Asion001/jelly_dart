...
@Freezed()
abstract class DatabaseConfigurationOptions with _$DatabaseConfigurationOptions {
  const factory DatabaseConfigurationOptions({
    ...
    required CustomDatabaseOptions customProviderOptions,
    ...
    required DatabaseConfigurationOptionsLockingBehavior lockingBehavior,
  }) = _DatabaseConfigurationOptions;
  
  factory DatabaseConfigurationOptions.fromJson(Map<String, Object?> json) => _$DatabaseConfigurationOptionsFromJson(json);
}
