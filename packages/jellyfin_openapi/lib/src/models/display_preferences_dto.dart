...
abstract class DisplayPreferencesDto with _$DisplayPreferencesDto {
  const factory DisplayPreferencesDto({
    ...
    required String? indexBy,

    /// Gets or sets a value indicating whether [remember indexing].
    @JsonKey(name: 'RememberIndexing')
    required bool rememberIndexing,

    /// Gets or sets the height of the primary image.
    @JsonKey(name: 'PrimaryImageHeight')
    required int primaryImageHeight,

    /// Gets or sets the width of the primary image.
    @JsonKey(name: 'PrimaryImageWidth')
    required int primaryImageWidth,

    /// Gets or sets the custom prefs.
    @JsonKey(name: 'CustomPrefs')
    required Map<String, String?> customPrefs,

    /// Gets or sets the scroll direction.
    @JsonKey(name: 'ScrollDirection')
    required DisplayPreferencesDtoScrollDirection scrollDirection,
    ...
    required bool rememberSorting,

    /// Gets or sets the sort order.
    @JsonKey(name: 'SortOrder')
    required DisplayPreferencesDtoSortOrder sortOrder,
