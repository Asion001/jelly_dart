...
mixin _$InboundKeepAliveMessage {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is InboundKeepAliveMessage);
  }
...
/// @nodoc
class $InboundKeepAliveMessageCopyWith<$Res> {
  $InboundKeepAliveMessageCopyWith(
    InboundKeepAliveMessage _,
    $Res Function(InboundKeepAliveMessage) __,
  );
}
...
class _InboundKeepAliveMessage implements InboundKeepAliveMessage {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _InboundKeepAliveMessage);
  }
