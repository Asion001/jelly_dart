...
mixin _$MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(name: $name, originalTitle: $originalTitle, path: $path, metadataLanguage: $metadataLanguage, metadataCountryCode: $metadataCountryCode, providerIds: $providerIds, year: $year, indexNumber: $indexNumber, parentIndexNumber: $parentIndexNumber, premiereDate: $premiereDate, isAutomated: $isAutomated)';
  }
}
...
/// @nodoc
@JsonSerializable()
class _MovieInfo implements MovieInfo {
  const _MovieInfo({
