...
part 'music_video_info.freezed.dart';
part 'music_video_info.g.dart';

@Freezed()
abstract class MusicVideoInfo with _$MusicVideoInfo {
  const factory MusicVideoInfo({
  ...
  factory MusicVideoInfo.fromJson(Map<String, Object?> json) => _$MusicVideoInfoFromJson(json);
}
