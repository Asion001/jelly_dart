...
part 'person_lookup_info.freezed.dart';
part 'person_lookup_info.g.dart';

@Freezed()
abstract class PersonLookupInfo with _$PersonLookupInfo {
  const factory PersonLookupInfo({
  ...
  factory PersonLookupInfo.fromJson(Map<String, Object?> json) => _$PersonLookupInfoFromJson(json);
}
