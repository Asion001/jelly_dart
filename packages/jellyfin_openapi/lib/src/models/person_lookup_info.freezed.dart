...
mixin _$PersonLookupInfo {
  ...
  /// Create a copy of PersonLookupInfo
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PersonLookupInfoCopyWith<PersonLookupInfo> get copyWith =>
      _$PersonLookupInfoCopyWithImpl<PersonLookupInfo>(
        this as PersonLookupInfo,
        _$identity,
      );

  /// Serializes this PersonLookupInfo to a JSON map.
  ...
  @override
  String toString() {
    return 'PersonLookupInfo(name: $name, originalTitle: $originalTitle, path: $path, metadataLanguage: $metadataLanguage, metadataCountryCode: $metadataCountryCode, providerIds: $providerIds, year: $year, indexNumber: $indexNumber, parentIndexNumber: $parentIndexNumber, premiereDate: $premiereDate, isAutomated: $isAutomated)';
  }
}

/// @nodoc
abstract mixin class $PersonLookupInfoCopyWith<$Res> {
  factory $PersonLookupInfoCopyWith(
    PersonLookupInfo value,
    $Res Function(PersonLookupInfo) _then,
  ) = _$PersonLookupInfoCopyWithImpl;
  @useResult
  $Res call({
...
/// @nodoc
class _$PersonLookupInfoCopyWithImpl<$Res>
    implements $PersonLookupInfoCopyWith<$Res> {
  _$PersonLookupInfoCopyWithImpl(this._self, this._then);

  final PersonLookupInfo _self;
  final $Res Function(PersonLookupInfo) _then;
...
/// Adds pattern-matching-related methods to [PersonLookupInfo].
extension PersonLookupInfoPatterns on PersonLookupInfo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PersonLookupInfo value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _PersonLookupInfo() when $default != null:
...
/// @nodoc
@JsonSerializable()
class _PersonLookupInfo implements PersonLookupInfo {
  const _PersonLookupInfo({
  ...
  factory _PersonLookupInfo.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PersonLookupInfoCopyWith<_PersonLookupInfo> get copyWith =>
      __$PersonLookupInfoCopyWithImpl<_PersonLookupInfo>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PersonLookupInfoToJson(this);
  }
...
/// @nodoc
abstract mixin class _$PersonLookupInfoCopyWith<$Res>
    implements $PersonLookupInfoCopyWith<$Res> {
  factory _$PersonLookupInfoCopyWith(
    _PersonLookupInfo value,
    $Res Function(_PersonLookupInfo) _then,
  ) = __$PersonLookupInfoCopyWithImpl;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'Name') String? name,
...
/// @nodoc
class __$PersonLookupInfoCopyWithImpl<$Res>
    implements _$PersonLookupInfoCopyWith<$Res> {
  __$PersonLookupInfoCopyWithImpl(this._self, this._then);

  final _PersonLookupInfo _self;
  final $Res Function(_PersonLookupInfo) _then;
