...
part 'playback_start_info.freezed.dart';
part 'playback_start_info.g.dart';

/// Class PlaybackStartInfo.
@Freezed()
abstract class PlaybackStartInfo with _$PlaybackStartInfo {
  const factory PlaybackStartInfo({
    ...
    required PlaybackStartInfoPlayMethod playMethod,
    ...
    required PlaybackStartInfoRepeatMode repeatMode,

    /// Gets or sets the playback order.
    @JsonKey(name: 'PlaybackOrder')
    required PlaybackStartInfoPlaybackOrder playbackOrder,
