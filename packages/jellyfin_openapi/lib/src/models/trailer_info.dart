...
part 'trailer_info.freezed.dart';
part 'trailer_info.g.dart';

@Freezed()
abstract class TrailerInfo with _$TrailerInfo {
  const factory TrailerInfo({
  ...
  factory TrailerInfo.fromJson(Map<String, Object?> json) => _$TrailerInfoFromJson(json);
}
