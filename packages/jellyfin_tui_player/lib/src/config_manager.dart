...
import 'package:jellyfin_tui_player/src/models/config.dart';
...
class ConfigManager {
  ...
  static String _getDefaultConfigDir() {
    ...
    if (io.Platform.isLinux || io.Platform.isMacOS) {
      ...
      return p.join(configBase, 'jellyfin-tui');
    }
    ...
    if (io.Platform.isWindows) {
      ...
      if (appData != null) {
        return p.join(appData, 'jellyfin-tui');
      }
    }

    // Fallback
    return p.join(home, '.jellyfin-tui');
  }
